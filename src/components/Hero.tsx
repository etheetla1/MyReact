...
import { AnimatedSection, Badge, OptimizedImage, Footer, SEOHead } from "./common";
...
const Hero = () => {
  ...
  return (
    <>
      <SEOHead 
        title="Home"
        description="Full-stack developer and cloud engineer specializing in AWS, React, Node.js, and AI-powered solutions. Building scalable, secure web applications with modern technologies."
